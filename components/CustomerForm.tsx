...
const CustomerForm = ({ type, customer, setCustomer, submitting, handleSubmit }) => {
  const [date, setDate] = useState(customer.dateofbirth ? new Date(customer.dateofbirth) : undefined);

  useEffect(() => {
    if (customer.dateofbirth) {
      setDate(new Date(customer.dateofbirth));
    }
