...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var n;
            (e = document.querySelector("#kt_app_header_menu"),
            t = document.querySelector("#kt_app_sidebar_menu_wrapper"),
            null !== e && null !== t) && (t && (n = menuWrapper.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(n, menuWrapper) && menuWrapper.scroll({
                top: KTUtil.getRelativeTopPosition(n, menuWrapper),
                behavior: "smooth"
            }))
        }
    }
